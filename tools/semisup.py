...
class SemisupModel(object):
  ...
  def add_semisup_loss_v2(self, a, b, labels, walker_weight=1.0, visit_weight=1.0, sigma=1.0):
    """Add semi-supervised classification loss to the model.
    ...
    match_ab = tf.exp(tf.scalar_mul(1.0/(2*sigma**2), match_ab))
